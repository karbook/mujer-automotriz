...
export const benefits: Benefits[] = [
  {
    icon: "book-open",
    title: "Masterclasses",
    description: "Ongoing access to classes on leadership, personal development, digitalization, and processes.",
    bgColor: "text-blue-500",
  },
  {
    icon: "trending-up",
    title: "Professional Development",
    description: "Free resources and an empowering community to strengthen your career.",
    bgColor: "text-green-500",
  },
  {
    icon: "users",
    title: "Supportive Community",
    description: "Network of Automotive Women and experts to share questions, experiences, and advice.",
    bgColor: "text-purple-500",
  },
  {
    icon: "graduation-cap",
    title: "Scholarship Access",
    description: "Discounts and opportunities in specialized products and services.",
    bgColor: "text-yellow-500",
  }
];
