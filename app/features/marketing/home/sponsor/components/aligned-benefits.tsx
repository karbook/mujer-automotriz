    ...
    return (
        <section className="max-w-7xl mx-auto px-8 py-20">
            <div className="rounded-3xl shadow-xl p-12  ">
                <h2 className="text-5xl font-extrabold text-center mb-6 text-black dark:text-white" style={{fontFamily:'var(--font-SF-Pro)'}}>
                    {t('Benefits Aligned with Your Goals')}
                </h2>
                <p className="text-2xl text-center max-w-3xl mx-auto text-gray-700 dark:text-gray-200 mb-12" style={{fontFamily:'var(--font-SF-Pro)'}}>
                            ...
                            {benefitsAligneds.map((benefit) => (
                                ...
                                >
                                    <div className="h-full flex flex-col justify-start p-6 rounded-3xl text-center shadow-md bg-white dark:bg-black text-black dark:text-white border dark:border-gray-500">
                                        ...
                                        <p className="text-lg mt-auto font-semibold">{t(benefit.description)}</p>
                                    </div>
                                </CarouselItem>
                            ))}
                        </CarouselContent>
