...
export function ContributorBenefits() {
  ...
  const { t } = useTranslation();
    ...
    return (
        <>
            <section className="max-w-6xl mx-auto px-4 md:px-6 py-16 md:py-20 mt-8 md:mt-10 mb-8 md:mb-10 text-black dark:text-white relative">
                <div className="absolute inset-0 bg-gray-100 dark:bg-[#1A2E4A] rounded-3xl shadow-lg" />
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-12">
                    ...
                    <div className="max-w-md md:max-w-lg p-4 md:p-6 rounded-2xl bg-gradient-to-b from-gray-100 to-gray-300 dark:from-black/30 dark:to-black/50 dark:border-white/20 transition-all dark:hover:bg-[#053b5e] border dark:hover:border-blue-600 duration-300 text-center relative z-10 shadow-lg max-h-[380px] md:max-h-[450px]">
                        ...
                        <h3 className="text-2xl md:text-4xl font-bold text-black dark:text-white mt-4 md:mt-8">Colaboradora</h3>
                    </div>
                </div>
            ...
            <section className="max-w-7xl mx-auto px-8 py-20">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-900 dark:text-white">Beneficios</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 mt-2">
                        Sé parte de la comunidad y accede a los siguientes beneficios
                    </p>
                </div>
                ...
                <div className="relative mt-12">
                    ...
                    {/* 🖥️ Vista en grilla para escritorio */}
                    <div className="hidden md:grid grid-cols-2 gap-6">
                        {benefits.map((benefit, index) => (
